...
# 1 "33EV_main_v11.c"
# 86 "33EV_main_v11.c"
# 1 "../h/p33EV256GM106.h" 1
# 16 "../h/p33EV256GM106.h"
...
# 1 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/features.h" 1 3 4
# 9 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/stdio.h" 2 3 4
# 22 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/stdio.h" 3 4
# 1 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/bits/alltypes.h" 1 3 4
...
# 195 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/bits/alltypes.h" 3 4
typedef unsigned int size_t;
# 236 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/bits/alltypes.h" 3 4
typedef int ssize_t;
# 427 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/bits/alltypes.h" 3 4
typedef long long off_t;
# 597 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/bits/alltypes.h" 3 4
typedef struct _IO_FILE FILE;
# 23 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/stdio.h" 2 3 4
# 50 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/stdio.h" 3 4
...
# 88 "33EV_main_v11.c" 2
# 1 "c:\\program files\\microchip\\xc16\\v2.00\\bin\\bin\\../..\\include/stdbool.h" 1 3 4
# 89 "33EV_main_v11.c" 2
# 147 "33EV_main_v11.c"
__attribute__((section("__FOSCSEL.sec"),space(prog))) unsigned int _FOSCSEL = (0xFFFB);;
__attribute__((section("__FOSC.sec"),space(prog))) unsigned int _FOSC = (0xFFBF & 0xFFFF & 0xFFFD);;




__attribute__((section("__FWDT.sec"),space(prog))) unsigned int _FWDT = (0xFF9F);;

__attribute__((section("__FICD.sec"),space(prog))) unsigned int _FICD = (0xFFFE);;
__attribute__((section("__FPOR.sec"),space(prog))) unsigned int _FPOR = (0xFFFE);;
__attribute__((section("__FDMT.sec"),space(prog))) unsigned int _FDMT = (0xFFFE);;
# 174 "33EV_main_v11.c"
volatile unsigned int ecan1MsgBuf[32][8]
__attribute__((aligned(32 * 16)));
...
volatile int tickTime = 50;
volatile float peripheralClk = 39.77;
volatile float Pot_Volts;
volatile char can_rx, sent_rx, lin_rx;

char Buf_result[5 + 2];
char *pBuf;
char s[64];
volatile unsigned int LIN_RXBUF[8];
unsigned char mode;
...
_Bool I2C1_Start(void);
_Bool I2C1_Stop(void);
_Bool I2C1_Write(unsigned char data);
unsigned char I2C1_Read(_Bool send_ack);
void I2C1_Ack(void);
void I2C1_Nack(void);
...
int main(void)
{
    ...
    {
        LED_Receive();
        while ((PORTCbits.RC7 == 0) | (PORTCbits.RC8 == 0) | (PORTCbits.RC9 == 0));
        LATCbits.LATC4 = 0;
        LATCbits.LATC5 = 0;
        LATCbits.LATC6 = 0;
    }
...
# 356 "33EV_main_v11.c"
  ...
  if(canRxMessage.buffer_status == 0x05)
  {
   rxECAN(&canRxMessage);


              canRxMessage.buffer_status = 0x06;
                    }
...
_Bool I2C1_Write(unsigned char data)
{
    ...
    if(timeout == 0 || I2C1STATbits.ACKSTAT) return 0;
...
unsigned char I2C1_Read(_Bool send_ack)
{
    ...
    if(send_ack) I2C1CON1bits.ACKDT = 0;
    else I2C1CON1bits.ACKDT = 1;
...
float MLX90614_ReadTemp(void)
{
    ...
    if(!I2C1_Write((0x5A << 1) | 1))
    {
        I2C1_Stop();
        return -274.0;
    }

    low_byte = I2C1_Read(1);
    high_byte = I2C1_Read(1);
    pec = I2C1_Read(0);
    I2C1_Stop();
...
void I2C1_Init(void)
{
    ...
    I2C1BRG = (40000000UL / 100000L) - (40000000UL / 10000000) - 1;
...
unsigned char ZSSC4151_SetMode(ZSSC4151_Mode_t mode)
{
    unsigned char slaveAddr_W = (0x28 << 1) | 0;
...
{
    unsigned char slaveAddr_W = (0x28 << 1) | 0;
    unsigned char slaveAddr_R = (0x28 << 1) | 1;
    unsigned char commandByte = 0x80 | (nvmIndex & 0x1F);
...
{
    unsigned char slaveAddr_W = (0x28 << 1) | 0;
    unsigned char commandByte = 0x40 | (nvmIndex & 0x1F);
...
void Transmit_Data(void)
{
    ...
    LATCbits.LATC4 = ~PORTCbits.RC7;
    LATCbits.LATC5 = ~PORTCbits.RC8;
    LATCbits.LATC6 = ~PORTCbits.RC9;
    ...
    dbg_put_crlf();
# 936 "33EV_main_v11.c"
    SENT1DATH = ((~PORTCbits.RC9 & 1) << 14) | ((~PORTCbits.RC8 & 1) << 13) | ((~PORTCbits.RC7 & 1) << 12) | PotValue;
    SENT1DATL = (TempValue << 4);
    SENT1STATbits.TXEN = 1;
    Delayus(8000);
    SENT1STATbits.TXEN = 0;
...
void InitSENT1_RX(void)
{
    ...
    IPC45bits.SENT1EIP = 6;
    IFS11bits.SENT1EIF = 0;
    IEC11bits.SENT1EIE = 1;


    SENT1CON3 = (int)(8 * peripheralClk * tickTime * 0.80);
    SENT1CON2 = (int)(8 * peripheralClk * tickTime * 1.20);
    SENT1CON1bits.CRCEN = 1;
    SENT1CON1bits.PPP = 0;
    SENT1CON1bits.NIBCNT = 6;
...
void Can_RX_to_UART(void)
{
    ...
    hex_dig = (char)((canRxMessage.id & 0xff00) >> 8);
    ascii_hi = hex_dig & 0xF0;
    ascii_hi = (ascii_hi >> 4) + 0x30;
    ascii_lo = (hex_dig & 0x0F) + 0x30;

    dbg_putc(ascii_hi);
    dbg_putc(ascii_lo);

    hex_dig = (char)(canRxMessage.id & 0x00ff);
    ascii_hi = hex_dig & 0xF0;
    ascii_hi = (ascii_hi >> 4) + 0x30;
    ascii_lo = (hex_dig & 0x0F) + 0x30;
...
void Test_Mode(void)
{
    if ((PORTCbits.RC7 == 0) || (PORTCbits.RC8 == 0) || (PORTCbits.RC9 == 0))
    {
        delay_10ms(30);
...
;
 ...
 C1RXF0SID = ((0x123 & 0x07FF)<< 5);

 C1RXM0SID = (C1RXM0SID | 0x0008);
 C1RXF0SID = (C1RXF0SID & 0xFFF7);
...
void CAN_Transmit(void)
{
    ...
    ecan1MsgBuf[0][3] = (~PORTCbits.RC7 & 1) | ((~PORTCbits.RC8 & 1) << 1) | ((~PORTCbits.RC9 & 1) << 2);
...
void LIN_Transmit(void)
{
    ...
    p0 = (0x23 & 0x01) ^ ((0x23 & 0x02) >> 1) ^ ((0x23 & 0x04) >> 2) ^ ((0x23 & 0x10) >> 4);
    p0 = p0 & 0x01;
    p1 = ~(((0x23 & 0x02) >> 1) ^ ((0x23 & 0x08) >> 3) ^ ((0x23 & 0x10) >> 4) ^ ((0x23 & 0x20) >> 5));
    p1 = p1 & 0x01;
    ...
    while (U1STAbits.TRMT == 0);
    Delayus(((1000000/4800) + 0.5) * 0x4);
    id_byte = (p1 << 7) | (p0 << 6) | 0x23;
    U1TXREG = id_byte;
    Delayus(((1000000/4800) + 0.5) * 0x4);
# 1783 "33EV_main_v11.c"
    checksum = id_byte;



    data_byte = (~PORTCbits.RC7 & 1) | ((~PORTCbits.RC8 & 1) << 1) | ((~PORTCbits.RC9 & 1) << 2);
...
# 1911 "33EV_main_v11.c"
void rxECAN(mID *message)
{
 unsigned int ide=0;
 unsigned int rtr=0;
 unsigned long id=0;
# 1948 "33EV_main_v11.c"
...
# 2080 "33EV_main_v11.c"
    ...
    {
        LIN_RXBUF[lin_index] = datal & 0x00FF;
        lin_index++;
        if (lin_index == 8)
        {
            lin_rx = 1;
